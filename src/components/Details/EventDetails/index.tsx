...
export const EventDetails = (data: { data: { results: Object[] } }) => {
          ...
          <CardContent sx={{ flex: "1 0 auto" }}>
            ...
            >
              {!detailsData.description
                ? "This event, sadly, doesn't have any description about him on Marvel's API. You can check the list of characters and creators that participated, comics and series that it happened down below."
                : detailsData.description}
            </Typography>
          </CardContent>
        </Box>
